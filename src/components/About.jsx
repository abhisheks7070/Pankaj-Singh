...
const About = () => {
  return (<>
    <section id="about" className=" bg-gray-100 text-center  px-4 md:px-0 h-auto">
      <Divider />
      ...
      <div className='w-[80vw] md:mt-10 m-auto  flex flex-col md:flex-row justify-around items-center'>
        ...
        <div className="relative m-auto w-2/3 my-10 pb-full border-dotted border-2 border-red-600 bg-red-500 rounded-full">
              <Player
                autoplay
                loop
        ...
        <div className='my-auto md:w-[40vw]'>
            <div className="relative m-auto w-2/3 my-10 pb-full border-dotted border-2 border-slate-900 bg-slate-800 rounded-full">
              <Player
                autoplay
                loop
